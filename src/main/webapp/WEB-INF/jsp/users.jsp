...
<%--                    <td><input type="checkbox" <c:if test="${user.enabled}">checked</c:if> onclick="closeNoty()"/></td>--%>
                    <td><fmt:formatDate value="${user.registered}" pattern="dd-MMMM-yyyy"/></td>
                    <td><a><span class="fa fa-pencil"></span></a></td>
                    <td><a class="button" onclick="deleteRow(${user.id})"><span class="fa fa-remove"></span></a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
